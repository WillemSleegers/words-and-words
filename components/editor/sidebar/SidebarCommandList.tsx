...
export function SidebarCommandList({
  ...
  const commands: Command[] = [
    ...
    { id: 'toggle-save-status', label: settings.showSaveStatus ? 'Hide Save Status' : 'Show Save Status', icon: settings.showSaveStatus ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />, action: () => onSettingsChange({ showSaveStatus: !settings.showSaveStatus }), group: 'Settings', keywords: ['save', 'status', 'indicator', 'autosave'] },
